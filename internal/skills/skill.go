...
var builtinSkills = []Skill{
	...
	},
	{
		...
		Tools:     []string{"plugin_list", "plugin_status", "plugin_start", "plugin_stop", "plugin_restart", "plugin_run", "plugin_install", "plugin_delete", "plugin_logs"},
	...
	},
	{
		...
		Tools:     []string{"kb_list", "kb_create", "kb_add_texts", "kb_search", "kb_delete", "kb_clear", "kb_list_docs", "kb_delete_chunks", "read_file", "read_media_file", "wiki_list", "wiki_read", "wiki_save", "wiki_delete", "wiki_search", "wiki_reindex", "write_file", "list_directory"},
	...
	},
	{
		...
		Tools:     []string{"catalog_search", "catalog_get_detail", "catalog_list_files", "catalog_set_token", "catalog_get_accounts"},
	...
	},
	{
		...
		Description: "使用已下载的模型进行实际推理：文本嵌入、语义相似度等",
		Category:    "toolbox", Package: "everevo", Enabled: true,
		Tools:     []string{"toolbox_list_models", "toolbox_embed"},
		Resources: []string{"everevo://models/tool"},
		SystemPrompt: "你是推理工具箱。帮助用户使用已下载的模型执行实际推理任务，如文本嵌入和语义相似度计算。引导用户选择合适的模型和参数。",
	},
	{
	...
	},
	{
		...
		Tools:     []string{"agent_list", "agent_create", "agent_run", "memory_list", "memory_search", "memory_delete", "memory_add_fact", "memory_clear", "core_list", "core_add", "core_delete", "session_list", "session_delete", "graph_list", "graph_add_edge", "graph_delete_node", "graph_rename_node", "experience_list", "experience_delete", "library_list", "library_create", "library_delete"},
