...
// Returns the composite score (0-1) used for strength updates.
func (a *App) ParadigmFeedback(id string, matchQuality, executionQuality, outcomeQuality float64, reason string) (float64, error) {
	if a.paradigmManager == nil {
		return 0, fmt.Errorf("范式库未就绪")
	}
